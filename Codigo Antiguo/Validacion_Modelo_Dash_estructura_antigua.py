...
v=[productos,familias,camiones,dias, dias1 ,columnas,A1,B1]
filehandler = open("v.obj", 'wb')
...
# In[25]:
v1=[lotepedido,CosteStock,piezascont,piezas_largo_box,b,demanda,stockInicial,valor,PC,L,nu,NT_lw,NT_up,piezas_largo_box,CosteStock]
filehandler = open("v1.obj", "wb")
pickle.dump(v1,filehandler)
filehandler.close()
