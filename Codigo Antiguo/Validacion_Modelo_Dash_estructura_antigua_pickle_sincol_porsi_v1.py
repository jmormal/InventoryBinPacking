...
def main():
    ...
    model.CantidadPedir2 = pe.Var(model.i,model.f, model.c, model.t, domain=pe.Integers, bounds=(0,None) )
    model.ContenedoresCamion = pe.Var(model.c,model.t,model.i, domain=pe.Integers)
